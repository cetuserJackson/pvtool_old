    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                html.P(
                    id="description",
                    children="Since 2019, CET has been working with the Office of Naval Research (ONR) to develop and validate carbon fiber solutions \
                        for Full Ocean Depth (6,000 m) underwater pressure vessels.  Through comprehensive engineering studies conducted in partnership \
                        with the College of Engineering at University of Rhode Island, CET has developed engineering models to optimize the fabrication \
                        of underwater carbon fiber pressure vessels.  These models have been thoroughly validated and proven through testing at the Woods \
                         Hole Oceanographic Institute (WHOI) Hydrostatic Test Facility.  Please contact STAYDRY@USACET.COM for more information.",
                ),
                html.Div(
                            children = [
                                                    ...
                                                    children=[
                                                                ...
                                                                html.Div(
                                                                    ...
                                                                    children=[
                                                                        ...
                                                                        html.H5("Service Depth:", className="dim-title"),
...
def update_output2(tubeod, implosion_pressure):
